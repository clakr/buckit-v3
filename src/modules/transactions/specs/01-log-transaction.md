...
**Trigger:** User clicks "New Transaction" from the account detail page or a global action.
...
3. On submit:
   ...
   - Creates Transaction record. Account balance is computed, not stored — no recalculation needed at write time.
4. Dialog closes. Account detail updates with new transaction. Success toast.
