    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "[&>div:not([data-slot=dialog-header],[data-slot=dialog-footer])]:no-scrollbar [&>div:not([data-slot=dialog-header],[data-slot=dialog-footer])]:max-h-[75svh] [&>div:not([data-slot=dialog-header],[data-slot=dialog-footer])]:overflow-y-auto",
